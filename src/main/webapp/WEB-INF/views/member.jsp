...
<body>
	<nav class="navbar">
		<ul class="navbar-nav">
			<li class="logo"><a href="home.html" class="nav-link"> <span
					class="link-text logo-text">Admin</span> <svg aria-hidden="true"
						focusable="false" data-prefix="fad" data-icon="angle-double-right"
			...
			<li class="nav-item"><a href="member.html" class="nav-link">
			...
			<li class="nav-item"><a href="apartments.html" class="nav-link">
					<svg aria-hidden="true" focusable="false" data-prefix="fad"
			...
			<li class="nav-item"><a href="sale-content.html"
			...
			<li class="nav-item"><a href="statistics.html" class="nav-link">
					<svg aria-hidden="true" focusable="false" data-prefix="fad"
            ...
            </svg> <svg class="theme-icon" id="solarIcon" aria-hidden="true"
						focusable="false" data-prefix="fad" data-icon="sun" role="img"
						xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
            ...
            </svg> <svg class="theme-icon" id="darkIcon" aria-hidden="true"
						focusable="false" data-prefix="fad" data-icon="sunglasses"
						role="img" xmlns="http://www.w3.org/2000/svg"
						viewBox="0 0 576 512"
            ...
            </svg> <span class="link-text">Logout</span>
			</a></li>
		</ul>
	</nav>
	<main>
